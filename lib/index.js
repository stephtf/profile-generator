...
const managerQuestions = () => {
    ...
    .prompt(managerQ)
    .then((managerData) => {
        if (managerData.addMore == "yes, I would like to add another") {
            firstQuestion(); 
        } else if (managerData.addMore == "no. I'm done adding to my team") {
...
const engineerQuestions = () => {
    return inquirer 
        .prompt(engineerQ)
        .then((engineerData) => {
            if (engineerData.addMore == "yes, I would like to add another") {
                firstQuestion(); 
            } else if (engineerData.addMore == "no. I'm done adding to my team") {
...
const internQuestions = () => {
    return inquirer 
        .prompt(internQ) 
        .then((internData) => {
            if (internData.addMore == "yes, I would like to add another") {
                firstQuestion(); 
            } else if (internData.addMore == "no. I'm done adding to my team") {
